...
“From investigating these three variables and their relationship with violent crime rates we find that the percentage of working mums has no correlation with crime rates and the percentage of two parent families has the strongest.”

</div>

So we conclude that pct2Par is the best explanatory variable of the three to predict violent crime in a region and thus include that in our model.

---

class: inverse, center, middle

# Section 3: Crimes and Demography
...
- **Social:** The greatest factor was the percentage of two-parent households.
- **Demographic:** No significant relationship was found in the demographic factors
