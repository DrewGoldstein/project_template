...
# Join the GeoJSON spatial data with your dataset 'data', handling missing values
my_sf_merged <- my_sf %>%
...
# Create a color palette with domain from min_value to 3000
...
leaflet(data = my_sf_merged) %>%
  ...
  addLegend(
    pal = pal,
    values = c(min_value, 500),  # Adjust the legend scale
    opacity = 0.7,
