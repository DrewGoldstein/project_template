...
plot1 <- ggplot(family_statistics_long, aes(
...
plot2 <- ggplot(family_statistics_long, aes(
...
plot3 <- ggplot(family_statistics_long, aes(
  x = Working_moms, 
  y = violentPerPop)) +
...
combined_plot <- plot1 + plot2 + plot3 + plot_layout(ncol = 2)
combined_plot
```
